...
export const brandDevelopment: DivisionServiceContent = {
  ...
  scope: [
    {
      ...
      detail:
        'We define who you serve, what sets you apart, and the few messages every channel should carry. The website, social posts, and ads all end up telling the same story.',
    },
    {
      title: 'Identity: logo system, color, and type',
      detail:
        'A logo system with versions for every size and background, a color palette, and typefaces that work on screen and in print. If your current logo has recognition worth keeping, we can refine it instead of starting over.',
    },
    {
      title: 'Brand voice',
      detail:
        'How the business sounds in captions, emails, replies, and on the phone, written down with examples. Anyone on your team, or ours, can write in it.',
    },
    {
      title: 'Visual system and brand guidelines',
      detail:
  ...
  process: [
    ...
    },
    {
      title: 'Prioritize',
      detail:
        'We agree on what to keep, what to refine, and what to rebuild. The touchpoints customers see most get updated first.',
    },
    {
      title: 'Build the brand',
      detail:
        'We develop the positioning, messaging, and identity, work through feedback with you, and finish with a visual system and a written voice.',
    },
    {
      title: 'Roll out and hand over',
      detail:
        'We apply the brand across your touchpoints, deliver the guidelines and templates, and hand over organized files your team and vendors can use.',
    },
  ],
  deliverables: [
    'Positioning statement and core messaging',
    'Logo system, color palette, and typography',
    'Brand voice guide with examples',
    'Brand guidelines document',
    'Templates for social, print, and signage',
    'Brand rollout across website, listings, and social',
  ],
  metrics: [
    'Touchpoints on the current brand',
    'Branded search and direct visits',
    'Profile and listing actions',
    'Inquiries and bookings after rollout',
  ],
  faqs: [
    {
