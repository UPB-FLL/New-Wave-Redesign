...
export const HERO_VIDEO_CLIPS: readonly HeroVideoClip[] = [
  ...
  {
    id: 7140931,
    title: 'Illuminated server rack in a data center',
    credit: 'MrColo',
    theme: 'managed-services',
    src: pexelsVideo(7140931, '7140931-hd_1280_720_24fps.mp4'),
    srcCompact: pexelsVideo(7140931, '7140931-sd_960_540_24fps.mp4'),
    poster: pexelsPoster(7140931, 'pexels-photo-7140931.jpeg'),
  },
  {
    id: 8201290,
  ...
  {
    id: 18780266,
    title: 'Technician wiring a new wall outlet during a network installation',
    credit: 'Johnny Chen',
    theme: 'it-services',
    src: pexelsVideo(18780266, '18780266-hd_1280_720_30fps.mp4'),
    srcCompact: pexelsVideo(18780266, '18780266-sd_960_540_30fps.mp4'),
    poster: pexelsPoster(18780266, 'technician-attendance-18780266.jpeg'),
  },
  {
    id: 7108186,
